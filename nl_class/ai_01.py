#Задача - классифицировать по признакам 1й - длинна чешелистика, 2й - ширина чешелистика, 3й - длинна лепестка, 4й - ширина лепестка, что это за цветок.  # noqa: E501

import numpy as np

INPUT_DIM = 4 # количество параметров на входе: 1й - длинна чешелистика, 2й - ширина чешелистика, 3й - длинна лепестка, 4й - ширина лепестка  # noqa: E501
OUT_DIM = 3 # по количеству классов на выходе. Всего три класса у цветка Ирис: 'Setosa', 'Versicolor', 'Virginica'  # noqa: E501
H_DIM = 10 # количество нейронов в первом слое, я бы поставил 12, но автор поставил 10. Моя логика = 4 *3 = 12 вариантов.  # noqa: E501

x = np.array([12.4, 2.1, 6.5, 1.2]) # перечисленны признаки. 1й - длинна чешелистика, 2й - ширина чешелистика, 3й - длинна лепестка, 4й - ширина лепестка  # noqa: E501
